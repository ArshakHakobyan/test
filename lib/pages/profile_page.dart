...
import 'package:telcell_copy/pages/payment_invoces_page.dart';
          ...
          child: Column(
            children: [
              ...
              ThreeFileldWidget(
                ...
                firstFieldroute: ChangeNotifierProvider(
                    create: (BuildContext context) => FinancePageModel(),
                ...
                thirdFieldroute: const PaymentInvocies(),
              ),
              ThreeFileldWidget(
                hasAmountField: true,
